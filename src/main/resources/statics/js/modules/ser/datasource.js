$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '用户', name: 'user', index: 'user', width: 40 }, 			
			...
			{ label: '登记日期', name: 'txDate', index: 'tx_date', width: 80 }, 			
			{ label: '更新日期', name: 'upDate', index: 'up_date', width: 80 }, 			
